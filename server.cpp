...
const size_t k_max_msg = 32 << 20; // likely larger than the kernel buffer 32 MiB (Megabyte = 1,000,000 = 10^6, Mebibyte = 1,048,576 = 2^20)
...
static void handle_write(Conn *conn) {
  ...
  // if all data from outgoing written, switch to read
...
static void handle_read(Conn *conn) {
  ...
  // Q: Why call this in a loop? See explanation of 'pipelining'
